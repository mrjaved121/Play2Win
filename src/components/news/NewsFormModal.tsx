...
interface NewsFormModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (input: NewNewsInput) => Promise<void>;
...
export function NewsFormModal({ open, onClose, onSubmit, initial }: NewsFormModalProps) {
  return (
    <Modal open={open} onClose={onClose} title={initial ? "Edit entry" : "Add entry"}>
      {open && <NewsForm initial={initial} onClose={onClose} onSubmit={onSubmit} />}
    </Modal>
  );
}

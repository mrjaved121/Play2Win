...
/// [LobbyScreen] game hub; the slot machine itself ([HomeScreen], despite
/// the name) is a full-screen flow pushed above the shell like wallet,
/// profile, rewards and achievements. Every cold start hits [SplashScreen]
/// first, which then routes to Onboarding (first launch only) or straight
/// to the Lobby.
